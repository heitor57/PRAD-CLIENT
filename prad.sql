...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Out-2017 às 15:08
...
INSERT INTO `cliente` (`CLI_CODIGO`, `CLI_NOME`, `CLI_EMAIL`, `CLI_TELEFONE`) VALUES
...
--
ALTER TABLE `cliente`
  MODIFY `CLI_CODIGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
